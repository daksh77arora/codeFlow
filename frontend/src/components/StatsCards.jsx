...
function StatsCards({ activeSessionsCount, recentSessionsCount, stats = {} }) {
  return (
    <div className="lg:col-span-1 grid grid-cols-1 gap-6">
      ...
      <div className="card bg-base-100 border-2 border-accent/20 hover:border-accent/40">
        <div className="card-body">
          <div className="text-4xl font-black mb-1">{stats.problemsSolved || 0}</div>
          <div className="text-sm opacity-60">Problems Solved</div>
          <div className="text-xs opacity-50 mt-1">{stats.totalPoints || 0} points</div>
        </div>
      </div>
    </div>
  );
